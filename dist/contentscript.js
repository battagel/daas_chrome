...
/* harmony export */ });
/* harmony import */ var _data_datamodel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data/datamodel */ "./src/data/datamodel.ts");
...
class Collector {
    constructor(api_url) {
        ...
        this.phrase_model = new _data_datamodel__WEBPACK_IMPORTED_MODULE_0__.PhraseModel;
    }
    collect() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PhraseModel: () => (/* binding */ PhraseModel)
/* harmony export */ });
class PhraseModel {
    constructor() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DexieDatabase: () => (/* binding */ DexieDatabase)
/* harmony export */ });
/* harmony import */ var dexie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dexie */ "./node_modules/dexie/dist/modern/dexie.mjs");
/* harmony import */ var _data_datamodel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../data/datamodel */ "./src/data/datamodel.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class DexieDatabase extends dexie__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
    ...
    get_keys() {
        return __awaiter(this, void 0, void 0, function* () {
            const keys = yield this.data_table.orderBy("phrase").keys();
            return keys;
        });
    }
    // Get all keys given list of types
    get_data_items_by_type(categories) {
        return __awaiter(this, void 0, void 0, function* () {
            const db_data = yield this.data_table
                .where("category")
                .anyOf(categories)
                .toArray();
            let data_model = new _data_datamodel__WEBPACK_IMPORTED_MODULE_1__.PhraseModel();
    ...
    get_all() {
        return __awaiter(this, void 0, void 0, function* () {
            const db_data = yield this.data_table.toArray();
            let phrase_model = new _data_datamodel__WEBPACK_IMPORTED_MODULE_1__.PhraseModel();
    ...
    bulk_insert(data_model) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.data_table.bulkPut(data_model.export_list());
        });
    }
    clear_db() {
        return __awaiter(this, void 0, void 0, function* () {
...
/* harmony export */ });
class HTMLEditor {
    tooltip(phrase_item, original_word) {
        ...
        // }
        var tooltip_text = "<span class='tooltiptext'><b>" +
            phrase_item.phrase +
            "</b>" +
            " - " +
            number_explanations +
...
/***/ "./src/processing/pageprocessor.ts":
/*!*****************************************!*\
  !*** ./src/processing/pageprocessor.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PageProcessor: () => (/* binding */ PageProcessor)
/* harmony export */ });
/* harmony import */ var _htmleditor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./htmleditor */ "./src/processing/htmleditor.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class PageProcessor {
    constructor(data_model) {
        this.html_editor = new _htmleditor__WEBPACK_IMPORTED_MODULE_0__.HTMLEditor;
    ...
    scan() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (content_element) {
                ...
                text_elements = content_element.querySelectorAll("p, h1, h2, h3, h4, h5, h6, li");
            }
            else {
            ...
            for (var i = 0; i < text_elements.length; i++) {
                yield this.update_paragraph(text_elements[i]);
            }
        });
    }
    update_paragraph(para_obj) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (var ptr = len - 1; ptr >= 0; ptr--) {
                ...
                if (char === ">") {
                    ...
                    else if (link_close.test(paragraph.substring(ptr, tag_ptr + 1))) {
                        link = false;
                    }
                    tag_ptr = -1;
                }
    ...
    process_word(word_start, word_end, para_text) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var original_word = para_text.substring(word_start, word_end + 1);
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _database_dexie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./database/dexie */ "./src/database/dexie.ts");
/* harmony import */ var _processing_pageprocessor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./processing/pageprocessor */ "./src/processing/pageprocessor.ts");
/* harmony import */ var _collecting_collector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./collecting/collector */ "./src/collecting/collector.ts");
...
chrome.storage.sync.get(["categories"], function (options) {
    ...
    db.get_key_count().then((keys_count) => {
        if (keys_count > 0) {
            console.log("Cache already populated");
            // Query from DB
            db.get_all().then((phrase_model) => {
                let page_processor = new _processing_pageprocessor__WEBPACK_IMPORTED_MODULE_1__.PageProcessor(phrase_model);
                page_processor.scan();
            ...
            // Query from API
            collector.collect().then((phrase_model) => {
